...
## v0.5 — Developer Edition

Added:
- Full clean release structure.
- `language/examples/store.panther`.
- Semantic Model engine.
- IR command.
- In-memory runtime data store.
- Executable GET and POST API endpoints.
- UI dashboard and model pages.
- Tests.
- Helper scripts.
...
## Phase 10.1 — Stable Release Preparation

Prepared PantherLang stable release candidate:
- version freeze at 1.0.0-rc1
- stable release manifest
- stable CLI surface documentation
- Phase 9 production baseline verification
- release candidate generation test

Next: Phase 10.2 Installer & Distribution.

## Phase 10.2 — Installer & Distribution

Added installer and distribution foundation:
- Linux installer/uninstaller
- macOS installer command
- Windows PowerShell installer foundation
- distribution manifest
- distribution archive validation
- global Panther command verification

Next: Phase 10.3 Official Package Registry.

## Phase 10.3 — Official Package Registry

Added local-first official package registry foundation:
- registry manifest
- package publishing
- package search/list
- package install
- Panther registry CLI command
- verification with real package publish/install cycle

Next: Phase 10.4 Official Documentation & Website.

## H1 — Enterprise Testing & Validation

Added release-hardening enterprise validation:
- enterprise workflow tests
- fuzz testing foundation
- stress testing foundation
- benchmark smoke tests
- H1 validation report
- stable release baseline verification

Next: H2 Native Executables.
