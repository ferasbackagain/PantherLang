...
class ResponseMergeEngine:
    ...
    def normalize(
        ...
        if message_type == "event":
            # F5 patch:
            # Events are first-class DAP messages. They must pass through unchanged
            # so legacy Part2B v2 routing keeps returning launch/continue/pause/stop
            # as events where the established contract expects events.
            return message
