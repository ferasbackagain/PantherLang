...
from compiler.optimization.optimizer import optimize_ir, stable_fingerprint, write_compile_cache
...
from compiler.stdlib.stdlib_engine import is_stdlib_call, evaluate_stdlib_call, PantherStdlibError
    ...
    def semantic(self, ast_nodes: list[dict[str, Any]]) -> list[dict[str, Any]]:
        ...
        def eval_nodes(nodes: list[dict[str, Any]], local_symbols: dict[str, Any] | None = None) -> None:
            ...
            for node in nodes:
                ...
                except (PantherExpressionError, PantherControlFlowError, PantherLoopError, PantherFunctionError, PantherStructError, PantherModuleError, PantherStdlibError) as exc:
